...
def init(path="",confid=0.4,x=300,y=300):
    ...
    out = cv2.VideoWriter('C:\\Users\\Administrator\Desktop\\video_after_counting.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30,
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            for detection in output[0, 0, :, :]:
                ...
                if confidence > confid:
                    ...
                    if(class_name=="person"):
                        ...
                        cv2.putText(image, f"{fps:.2f} FPS", (1000, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(image, f"Persons: {count_person}", (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
