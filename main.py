...
label1=Label(w, text='counting person', fg='white', bg='#272727') #decorate it 
...
image_a=ImageTk.PhotoImage(Image.open("C:\\Users\\Administrator\\Desktop\\splash\\c2.png"))
image_b=ImageTk.PhotoImage(Image.open("C:\\Users\\Administrator\\Desktop\\splash\\c1.png"))
